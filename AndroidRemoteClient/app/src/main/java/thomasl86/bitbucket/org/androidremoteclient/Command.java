...
public class Command {
    ...
    public static final int KB_UP               = 0x2191; //Unicode
    public static final int KB_DOWN             = 0x2193; //Unicode
    public static final int KB_LEFT             = 0x2190; //Unicode
    public static final int KB_RIGHT            = 0x2192; //Unicode
